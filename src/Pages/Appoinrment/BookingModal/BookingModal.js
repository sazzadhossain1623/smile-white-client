...
function BookingModal({ treatment, setTreatment, selectedDate, refetch }) {
    ...
    const handleBooking = event => {
        ...
        // once data is saved then closed the modal
        ...
        <>
            ...
            <div className="modal">
                <div className="modal-box relative">
                    ...
                    <h2 className="text-xl text-secondary font-bold">{treatmentName}</h2>
                    <form onSubmit={handleBooking} className='grid grid-cols-1 gap-3 mt-6'>
                        ...
                        <input name='email' type="text" defaultValue={user?.email} disabled placeholder="Your Email Address" className="input w-full input-bordered" />
